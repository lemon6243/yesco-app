        ...
        <div className="px-6 py-5 overflow-y-auto text-sm leading-relaxed space-y-5">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 pl-1">
              ...
              <li>
                권역당 목표 세대수: <b>96,240 ~ 119,760세대</b> (4.01~4.99명 기준)
              </li>
              <li>
                난이도 우선순위:{" "}
          ...
          <section>
            ...
            <div className="space-y-2 text-gray-700">
              ...
              <div>
                ...
                <div className="pl-3">
                  A. 상한이 4.99명(119,760세대) 기준이므로, 서울 총 세대수
                  1,118,482를 9개로 나누면 평균이 124,276세대로 이미 상한을
                  초과합니다. <b>10개 권역</b>으로 전환하시면 평균이 111,848세대로
                  내려가 충족 가능합니다.
                </div>
              </div>
            </div>
